 ...
 * I use `Sizes.main` to limit the image to only 96 0px. This considerably reduce the size in KB of my images and they're much
...
export enum Sizes {
  tiny = '(max-width: 64px) 64px, (max-width: 196px) 196px',
